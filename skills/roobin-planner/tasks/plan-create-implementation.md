...
> **Phase:** 1 - Plan
> **Owner Agent:** roobin-planner (Sage)
...
params:
  action: create
  parent_id: "{story_task_id}"
  title: "Subtask {phase}.{num}: {description}"
  description: |
    ## Service
    ...
    ## Dependencies
    {subtask IDs que devem completar primeiro}
  type: subtask
  status: backlog
  priority: medium
```
...
params:
  ...
  content: "Implementation plan created with {N} subtasks"
```
